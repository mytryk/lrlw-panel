    ...
    <div class="card">
        <div class="card-header p-0">
            ...
            <ul class="breadcrumb mt-3 py-3 px-4 rounded" style="background-color: #e9ecef!important;">
                <li class="breadcrumb-item">
                    <a href="@route(getRouteName().'.home')" class="text-decoration-none">{{ __('Dashboard') }}</a>
                </li>
        ...
        <div class="mt-4 px-2 rounded">
            ...
            @if($cruds->count() > 0)
                ...
                <a href="" class="btn btn-block my-3 btn-outline-success"
                   @click.prevent="rebuildModal = true">{{ __('Re-Build All') }}
                    <i class="ml-3 icon-rocket"></i>
                </a>
                <div x-show="rebuildModal" class="cs-modal animate__animated animate__fadeIn">
                    <div class="bg-white shadow rounded p-5" @click.away="rebuildModal = false">
                        ...
                        <div class="mt-5 d-flex justify-content-between">
                            <a @click.prevent="rebuildModal = false" wire:click.prevent="buildAll"
                               class="text-white btn btn-success shadow">{{ __('Yes, Build it') }}</a>
                            <a @click.prevent="rebuildModal = false"
