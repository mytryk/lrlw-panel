    ...
    <div class="row align-items-baseline px-5">
        ...
        <div class="col-10 d-flex">
            <div class="custom-control custom-checkbox ">
                <input id="todo{{ $todo->id }}" class="custom-control-input" type="checkbox" @if($todo->checked) checked
                       @endif wire:model="checked">
                ...
                <div class="bg-white shadow rounded p-5" @click.away="modalIsOpen = false">
                    ...
                    <div class="mt-5 d-flex justify-content-between">
                        <a wire:click.prevent="delete"
                           class="text-white btn btn-success shadow">{{ __('Yes, Delete it') }}.
                        </a>
                        <a @click.prevent="modalIsOpen = false"
                           class="text-white btn btn-danger shadow">{{ __('No, Cancel it') }}.
                        </a>
                    </div>
                </div>
            </div>
