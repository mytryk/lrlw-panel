@component('admin::layouts.app')
    ...
    <ul>
        ...
        <li>Real time validation with
            <a href="https://github.com/livewire/livewire">Livewire</a>
        </li>
    ...
    <p>Check document out :
        <a href="https://github.com/rezaamini-ir/laravel-easypanel">Github repo</a>
    </p>
@endcomponent
