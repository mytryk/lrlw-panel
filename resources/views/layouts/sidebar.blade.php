        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item @isActive(getRouteName().'.home', 'selected')">
                    <a class="sidebar-link @isActive(getRouteName().'.home', 'active') "
                       href="@route(getRouteName().'.home')" aria-expanded="false">
                ...
                <li class="sidebar-item @isActive(getRouteName().'.crud.lists', 'selected')">
                    <a class="sidebar-link @isActive(getRouteName().'.crud.lists', 'active') "
                       href="@route(getRouteName().'.crud.lists')" aria-expanded="false">
